...
-XX:+UseParallelGC
```
知道答案是`-XX:InitialHeapSize=2147483648`和`-XX:MaxHeapSize=32210157568`。另外通过 [jvm默认配置](https://docs.oracle.com/javase/8/docs/technotes/guides/vm/gctuning/parallel.html#default_heap_size)发现这一段`Server JVM Default Initial and Maximum Heap Sizes
